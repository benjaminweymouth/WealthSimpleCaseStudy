...
In order to implement a new "WealthCoin" cryptocurrency, WealthSimple would need to employ a number of technologies, similar to the stack employed by Ethereum. Therefore, they would need to implement a data structure that holds a ledger such as a BlockChain class library, Smart Contracts, cryptography and a distributed peer-to-peer platform. In terms of the actual code, there are many ways to code a BlockChain, such as in C#, GoLang, Python or Rust. <sup>[18](#myendnote18)</sup> 
