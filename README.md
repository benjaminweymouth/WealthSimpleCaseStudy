...
The success or failure of a relatively new company in an emerging market like FinTech can be determined by analysing some core metrics. These metrics may include a market valuation, the number of employees, ETF performance and the company's annual revenue. Here is a listing of some of these core metrics for WealthSimple: 
...
Given this analysis, it is prudent to suggest a recommendation for WealthSimple to maintain their strategic positioning. Thus, this analysis proposes that WealthSimple should develop their own cryptocurrency, and that it should be called "WealthCoin." Since WealthSimple may face international competition, a cryptocurrency may provide it with a competitive advantage. WealthSimple could capitalize on the popularity of cryptocurrency and offer a digital currency specifically for it's Canadian customers. 

The idea of a new cryptocurrency may not seem novel, but other avenues of product diversity may be even more risky. For example, a foray into hardware during an age of semiconductor scarcity is ill-advised. WealthSimple has an exiting customer base that they could market a cryptocurrency to directly. They could engage in more collaborations with other companies, such as are doing with Twitter to integrate their WealthSimple Payment app into the Twitter system architecture. <sup>[17](#myendnote17)</sup> If they develop "WealthCoin", it could lead to the filing of new patents and create new innovation in the Canadian FinTech industry. 
